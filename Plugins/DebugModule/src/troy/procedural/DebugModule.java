...
public class DebugModule extends Module
{
	...
	protected BButton btnEvalNumeric = new BButton(Translate.text(
										"debugmodule:btn.evalNumeric"));
	protected BButton btnEvalColor = new BButton(Translate.text(
										"debugmodule:btn.evalColor"));
